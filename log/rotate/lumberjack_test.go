...
// TestIntervalRotate ...
func TestIntervalRotate(t *testing.T) {
	currentTime = fakeTime
	megabyte = 1

	t.Run("1h rotate", func(t *testing.T) {
		dir := makeTempDir("TestIntervalRotate1h", t)
		defer os.RemoveAll(dir)
	...
	t.Run("50h rotate", func(t *testing.T) {
		dir := makeTempDir("TestIntervalRotate50h", t)
		defer os.RemoveAll(dir)
