...
import (
	...
	"github.com/linthan/gocron/internal/routers/host"
	"github.com/linthan/gocron/internal/routers/install"
	"github.com/linthan/gocron/internal/routers/loginlog"
	"github.com/linthan/gocron/internal/routers/manage"
	"github.com/linthan/gocron/internal/routers/pms"
	"github.com/linthan/gocron/internal/routers/task"
	"github.com/linthan/gocron/internal/routers/tasklog"
	"github.com/linthan/gocron/internal/routers/user"
	"github.com/rakyll/statik/fs"
	"gopkg.in/macaron.v1"

	_ "github.com/linthan/gocron/internal/statik"
)
...
func Register(m *macaron.Macaron) {
	...
	//权限
	m.Group("/pms", func() {
		m.Post("/report", binding.Bind(pms.JSON{}), pms.Report)
		m.Get("/getPermission", pms.GetPermission)
		m.Get("/getOwnPermission", pms.GetOwnPermission)
	})
