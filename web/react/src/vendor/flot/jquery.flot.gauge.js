...
(function($) {
  ...
  var Gauge = (function() {
    ...
    Gauge.prototype.calculateLayout = function() {
      ...
      var outerRadiusV =
        (cellHeight - cellMargin * 2 - labelMargin * 2 - labelFontSize) / (1 + heightRatioV);
      ...
      var maxRadiusV =
        outerRadiusV - thresholdLabelMargin * 2 - thresholdLabelFontSize - thresholdWidth;
  ...
  function drawArc(context, cx, cy, r, w, rd1, rd2, lc, lw, fc) {
    ...
    context.lineTo(cx + (r - w) * Math.cos(rd2), cy + (r - w) * Math.sin(rd2));
