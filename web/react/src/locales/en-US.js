export default {
  ...
  'menu.setting.notify-config.email': 'Email',
  'menu.setting.notify-config.slack': 'Slack',
  'menu.setting.notify-config.webhook': 'Webhook',
  'menu.setting.monitor.login-log': 'Login Log',
  'menu.setting.pms': 'Permission',
